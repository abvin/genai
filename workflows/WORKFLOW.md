...
- Write detailed specs upfront for verification
...
### 5. Tests Elegance (Balanced)
- For non-trivial changes: pause and ask "is there a more elegant way?"
- If a fix feels hacky: "Knowing fixes I don't know now, implement the elegant solution"
- Skip this for simple work
- Challenge your own work before presenting it – don't over-engineer
...
4. **Explain Changes**: High-level summary as each step goes
